...
const TRANSLATIONS = {
  es: {
    ...
    "proy.item1.b1": "Sitio de siete páginas en HTML, CSS y JavaScript puro, sin frameworks ni bundler.",
    ...
    "pf.context.code.dd": "Repositorio público en GitHub",
    ...
    "pf.desc.includes.li1": "Sitio de siete páginas en HTML, CSS y JavaScript puro, sin frameworks ni bundler.",
    ...
    "pf.decisions.p": "El punto de partida fue el destino: quería desplegar en GitHub Pages, que sirve solo ficheros estáticos. El despliegue es un simple push a main, sin acción de CI ni compilación. Esa restricción marcó el resto de decisiones, y en todas prioricé mantener el sitio ligero y sin dependencias.",
  ...
  en: {
    ...
    "proy.item1.b1": "Seven-page site in plain HTML, CSS and JavaScript, with no frameworks or bundler.",
    ...
    "pf.context.code.dd": "Public repository on GitHub",
    ...
    "pf.desc.includes.li1": "Seven-page site in plain HTML, CSS and JavaScript, with no frameworks or bundler.",
    ...
    "pf.decisions.p": "The starting point was the target: I wanted to deploy on GitHub Pages, which only serves static files. Deployment is just a push to main, with no CI action or compilation. That constraint shaped every other decision, and in all of them I favoured keeping the site lightweight and dependency-free.",
    ...
    "pf.arch.detail.p": "There is no split between source and build output: the repository root is what GitHub Pages publishes, with a .nojekyll file so it serves the files without processing them. The root holds the eight HTML pages and everything else lives under assets/, with the CSS and JavaScript organised in two layers, one global and one per page.",
    ...
    "pf.balance.different.li1": "With no build step, the header, footer and <head> are literally repeated across all eight pages; changing something in all of them means going page by page. If I started over, I'd consider a small build step (or my own script) just to assemble those shared parts without losing the static deploy.",
