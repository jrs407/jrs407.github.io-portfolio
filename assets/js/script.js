...
const TRANSLATIONS = {
  es: {
    ...
    "for.degrees.desc": "Toda mi formación universitaria se ha cursado en la Universidad de Almería. El Máster arrancó antes de cerrar formalmente el Grado; más abajo explico por qué.",
    ...
    "for.master.p": "Especialidad en Big Data (infraestructura y bases de datos a gran escala, análisis de grandes volúmenes de datos y procesamiento distribuido), uno de los tres itinerarios del máster junto a Internet de las cosas y desarrollo web/móvil. Lo compagino con una jornada laboral completa.",
    ...
    "for.tfg.p2": "No pude defenderlo en la convocatoria ordinaria, así que lo defendí en la convocatoria de febrero de 2026. Por eso el Grado figura como finalizado en 2026, aunque el resto de asignaturas estaban superadas antes.",
    ...
    "for.overlap.i2.p": "El Trabajo de Fin de Grado no pude defenderlo en la convocatoria ordinaria; lo defendí en la convocatoria de febrero de 2026. Hasta esa fecha el Grado constaba como no finalizado pese a tener el resto del expediente aprobado.",
    "for.overlap.i3.h3": "Cómo se refleja en el CV",
    "for.overlap.i3.p": "De ahí que el currículum muestre el Grado terminando en 2026 y el Máster empezando unos meses antes: no son dos periodos independientes, sino esa transición. El Máster sigue en curso.",
    ...
    "con.faq.q2.p": "Sí: incorporación inmediata y a jornada completa. El Máster en Ingeniería Informática que curso es 100% online y no exige asistencia presencial, así que lo organizo fuera del horario laboral y no interfiere con un puesto presencial, híbrido o remoto.",
  ...
  en: {
    ...
    "for.degrees.desc": "All my university education was completed at the University of Almería. The Master's started before the Bachelor's was formally closed; I explain why below.",
    ...
    "for.master.p": "Big Data specialization (large-scale infrastructure and databases, analysis of large data volumes and distributed processing), one of the master's three tracks alongside Internet of Things and web/mobile development. I combine it with a full-time job.",
    ...
    "for.tfg.p2": "I couldn't defend it in the ordinary session, so I defended it in the February 2026 session. That's why the Bachelor's is listed as completed in 2026, even though the rest of the courses were passed earlier.",
    ...
    "for.overlap.i2.p": "I couldn't defend the Bachelor's thesis in the ordinary session; I defended it in the February 2026 session. Until then the Bachelor's was recorded as unfinished despite the rest of my record being passed.",
    "for.overlap.i3.h3": "How it shows on the CV",
    "for.overlap.i3.p": "Hence the CV shows the Bachelor's ending in 2026 and the Master's starting a few months earlier: they are not two independent periods, but that transition. The Master's is still ongoing.",
    ...
    "con.faq.q2.p": "Yes: immediate start and full-time. The Master's Degree in Computer Engineering I'm studying is 100% online and requires no in-person attendance, so I fit it around working hours and it doesn't clash with an on-site, hybrid or remote role.",
