...
const TRANSLATIONS = {
  es: {
    ...
    "proy.item1.b1": "Sitio de ocho páginas en HTML, CSS y JavaScript puro, sin frameworks ni bundler.",
    ...
    "pf.desc.includes.li1": "Sitio de ocho páginas en HTML, CSS y JavaScript puro, sin frameworks ni bundler.",
  ...
  en: {
    ...
    "proy.item1.b1": "Eight-page site in plain HTML, CSS and JavaScript, with no frameworks or bundler.",
    ...
    "pf.desc.includes.li1": "Eight-page site in plain HTML, CSS and JavaScript, with no frameworks or bundler.",
