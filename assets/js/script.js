...
const TRANSLATIONS = {
  es: {
    ...
    "hab.card.lang.p": "JavaScript y TypeScript son mi base tanto en backend como en frontend; uso el tipado estático de TypeScript para modelar el dominio y detectar errores antes de ejecutar. Java lo empleo para programación orientada a objetos y servicios con Spring, Python para modelos de datos e IA, y R para análisis estadístico.",
    ...
    "hab.card.fw.p": "Construyo APIs REST con Node.js y Express.js, e interfaces con React y Next.js (renderizado en servidor y rutas dinámicas). Angular lo utilizo como alternativa de frontend basada en componentes y TypeScript, Spring para servicios en Java y Spark para procesamiento distribuido sobre varios nodos.",
    ...
    "hab.card.db.p": "En SQL modelo esquemas relacionales, escribo consultas y cuido los índices (MySQL y PostgreSQL). Con la extensión PostGIS trabajo consultas espaciales sobre datos geográficos. En NoSQL manejo MongoDB (documental) y Cassandra (columnas anchas) para escenarios de alto volumen y escritura intensiva.",
    ...
    "hab.card.devops.p": "Contenerizo aplicaciones con Docker e imágenes reproducibles, orquesto varios servicios en local con docker-compose y preparo entornos idénticos en desarrollo y despliegue para eliminar el «en mi máquina funciona».",
    "hab.card.devops.applied": "<span>Dónde lo he aplicado</span> Despliegue en Docker de la aplicación desarrollada en las prácticas; este mismo portfolio incluye Dockerfile y docker-compose.",
    ...
    "hab.card.test.h3": "Testing y CI/CD",
    "hab.card.test.p": "Diseño tests unitarios para aislar y verificar la lógica, e integro procesos de integración y despliegue continuos que validan cada cambio de forma automática antes de que llegue a producción. El objetivo es que un fallo se detecte en minutos, no en cliente.",
    "hab.card.test.applied": "<span>Dónde lo he aplicado</span> Pruebas de la API de las prácticas y asignaturas de la mención de Ingeniería del Software centradas en calidad y verificación.",
    ...
    "hab.tag.ci": "Integración continua",
    "hab.tag.cd": "Despliegue continuo",
    ...
    "hab.soft.time.p": "Compagino el Máster con jornada laboral completa y con proyectos propios como Tokimori, priorizando tareas y fijando entregas realistas.",
    ...
    "hab.lang.jp.name": "Japonés",
    "hab.lang.jp.level": "Nivel inicial · en formación",
    "hab.lang.jp.p": "Lectura de los silabarios hiragana y katakana. Actualmente estudio el idioma de forma reglada en una academia.",
    ...
    "con.faq.q1.p": "Una llamada al +34 608 25 75 74. Si lo prefieres por escrito, escríbeme un correo.",
    "con.faq.q2.h3": "¿Estás disponible ya?",
    "con.faq.q2.p": "Sí: incorporación inmediata y a jornada completa. El Máster que curso es compatible con el horario laboral.",
  ...
  en: {
    ...
    "hab.card.lang.p": "JavaScript and TypeScript are my foundation on both backend and frontend; I use TypeScript's static typing to model the domain and catch errors before running. I use Java for object-oriented programming and services with Spring, Python for data and AI models, and R for statistical analysis.",
    ...
    "hab.card.fw.p": "I build REST APIs with Node.js and Express.js, and interfaces with React and Next.js (server-side rendering and dynamic routes). I use Angular as a component- and TypeScript-based frontend alternative, Spring for Java services, and Spark for distributed processing across multiple nodes.",
    ...
    "hab.card.db.p": "In SQL I model relational schemas, write queries and look after indexes (MySQL and PostgreSQL). With the PostGIS extension I work on spatial queries over geographic data. In NoSQL I use MongoDB (document) and Cassandra (wide-column) for high-volume, write-intensive scenarios.",
    ...
    "hab.card.devops.p": "I containerize applications with Docker and reproducible images, orchestrate several services locally with docker-compose, and prepare identical environments in development and deployment to eliminate \"works on my machine\".",
    "hab.card.devops.applied": "<span>Where I've applied it</span> Docker deployment of the application built during the internship; this very portfolio includes a Dockerfile and docker-compose.",
    ...
    "hab.card.test.h3": "Testing and CI/CD",
    "hab.card.test.p": "I design unit tests to isolate and verify logic, and integrate continuous integration and deployment processes that validate every change automatically before it reaches production. The goal is for a failure to be caught in minutes, not at the client.",
    "hab.card.test.applied": "<span>Where I've applied it</span> Testing the internship API and Software Engineering specialization courses focused on quality and verification.",
    ...
    "hab.tag.ci": "Continuous integration",
    "hab.tag.cd": "Continuous deployment",
    ...
    "hab.soft.time.p": "I combine the Master's with a full-time job and personal projects such as Tokimori, prioritizing tasks and setting realistic deadlines.",
    ...
    "hab.lang.jp.name": "Japanese",
    "hab.lang.jp.level": "Beginner · in progress",
    "hab.lang.jp.p": "Reading the hiragana and katakana syllabaries. I'm currently studying the language formally at a language school.",
    ...
    "con.faq.q1.p": "A call to +34 608 25 75 74. If you prefer it in writing, send me an email.",
    "con.faq.q2.h3": "Are you available now?",
    "con.faq.q2.p": "Yes: immediate start and full-time. The Master's I'm studying is compatible with working hours.",
